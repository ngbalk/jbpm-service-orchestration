...
public class WireMockTests {
    ...
    public void testMarshallWithCustomDomainDataObject() throws Exception{
        ...
        verify(postRequestedFor(urlMatching("/wire-mock"))
                .withRequestBody(equalToJson("{\"Data\":{\"incidentData\":{\"SupportActivityId\":\"abcdef\",\"OrganizationId\":\"xyz\",\"IncidentType\":\"Normal\"}},\"WorkerName\":\"wire-mock\",\"SignalInstanceInfo\":{\"ContainerId\":\"MyContainer\",\"ProcessInstanceId\":1,\"SignalName\":\"A\"}}"))
